...
INSERT INTO _design VALUES
    ...
    -- 163 (M-17, ARC B): claim-veiens dør og tenantens avsenderprofil.
    ...
    -- 187: kravet knyttes til kunden i partsregisteret.
    ('FUNCTION', 'm23_knytt_part(text,uuid)',                         'disponit_fordring_eier'),
    ...
    -- 149 (M-23, ARC B): sendedøra for claim-veien og avsenderprofilen.
    ('FUNCTION', 'm23_sett_avsender(text,text,text,text)',            'disponit_fordring_eier'),
    ...
    -- 171 (M-26, ARC B): tilbudsutløseren — kandidater, bokføring, lesedør.
    ...
    -- 174 (M-26, ARC B): plattformens arm i ord, per tilbud.
    ('FUNCTION', 'm26_tilbudsbildet(text,uuid[])',                        'disponit_prisbok_eier'),
    ...
    -- 155 (M-44, ARC B): kampanjeutløseren — kandidater, bokføring, lesedør.
    ('FUNCTION', 'm44_kampanjekandidater(integer)',                     'disponit_kampanje_eier'),
    ('FUNCTION', 'm44_bokfor_kampanjebestilling(text,uuid,uuid,text,text,bigint,bigint,text,jsonb)', 'disponit_kampanje_eier'),
    ('FUNCTION', 'm44_kampanjebestillingene(text,uuid)',                'disponit_kampanje_eier'),
    -- 156 (M-44, ARC B): claim-veiens dør og tenantens avsenderprofil.
