...
INSERT INTO _design VALUES
    ...
    ('FUNCTION', 'plan_nedetid_aggregert(text,uuid,timestamp with time zone,timestamp with time zone,integer,text,text)', 'disponit_m37_claimer'),
    ...
    ('FUNCTION', 'plan_nedetid_kandidater(integer)',                  'disponit_m37_claimer'),
