...
def _gyldig():
    return {
        ...
        "maalt": {
            ...
            "sideeffekt": {"injisert": 3, "til_utforelse": 3},
            ...
            "kvitteringsrace_konkurranser": 1, "kvitteringsrace_fullfort": 2,
            "kvitteringsrace_avvis_flagget": 1,
            "kvitteringsrace_kvittering_brukt": 1,
            "kvitteringsrace_falskt_avvist": 0,
...
@pytest.mark.parametrize("sti, verdi, hint", [
    ...
    # Kvittering-vs-avvis-rasen (scope-beslutningen §3).
    (["maalt", "kvitteringsrace_konkurranser"], 0, "rasen aldri kjørt"),
    (["maalt", "kvitteringsrace_fullfort"], 1, "en race-tråd hang"),
    (["maalt", "kvitteringsrace_avvis_flagget"], 0, "avvis flagget ikke avklaring"),
    (["maalt", "kvitteringsrace_kvittering_brukt"], 0, "kvitteringen ikke bevart"),
    (["maalt", "kvitteringsrace_falskt_avvist"], 1,
     "saken påsto avvist mens oppdraget levde"),
