...
import { visEhf } from "./flater/ehf.js";
import { visTollkode } from "./flater/tollkode.js";
import { visMyndighet } from "./flater/myndighet.js";
...
import { visOptimalisator } from "./flater/optimalisator.js";
...
const FLATER = {
  ...
  ehf: visEhf,
  tollkode: visTollkode,
  myndighet: visMyndighet,
  journal: visJournal,
  hms: visHms,
  likviditet: visLikviditet,
  prognose: visPrognose,
  optimalisator: visOptimalisator,
  mote: visMote,
  innhold: visInnhold,
