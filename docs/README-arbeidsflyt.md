...
**Steg 3 — Implementering (Claude Code):** Implementerer mot spesifikasjonen. Hver PR må inneholde: enhetstester, minst én test per akseptansekriterium fra modulen slik den står i gjeldende prototype, og en negativ test som beviser at handling utenfor policy faktisk stoppes.
